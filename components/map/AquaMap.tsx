 ...
 * supplies the ground and place labels, and since August 2026 it answers a
 * keyless request with a 200 and a tile stamped "API KEY REQUIRED" — so the
 * error handler below never fires and the watermark is the only symptom.
